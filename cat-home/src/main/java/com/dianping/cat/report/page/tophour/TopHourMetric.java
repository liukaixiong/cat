...
public class TopHourMetric extends BaseVisitor {
	...
	public TopHourMetric(int count, int tops, ExceptionRuleConfigManager configManager) {
		m_configManager = configManager;
		m_error = new MetricItem(count, tops);
	}

	public TopHourMetric(int count, int tops, ExceptionRuleConfigManager configManager, List<String> excludedDomains) {
	...
	public TopHourMetric setEnd(Date end) {
		m_end = end;
		return this;
	}

	public TopHourMetric setStart(Date start) {
		m_start = start;
		return this;
	}
