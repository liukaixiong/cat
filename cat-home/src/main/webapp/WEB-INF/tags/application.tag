    ...
    <div class="main-container" id="main-container">
        ...
        <div id="sidebar" class="sidebar   responsive">
            ...
            <ul class="nav nav-list" style="top: 0px;">
                    ...
                    <%--</ul>--%>
                    <%--</li>--%>
                <li id="my_report" class="hsub"><a href="#" class="dropdown-toggle"> <i
                        class="menu-icon fa fa-tachometer"></i> <span class="menu-text">自定义大盘</span>
                    <b class="arrow fa fa-angle-down"></b>
                </a> <b class="arrow"></b>
                    <ul class="submenu">
                        <li id="dashbord_hour_report">
                            <a href="/cat/r/tophour?op=view&domain=${model.domain}">
                                <i class="menu-icon fa fa-caret-right"></i>小时报错大盘</a>
                            <b class="arrow"></b></li>
                        <b class="arrow"></b>
                        <li id="dashbord_hour_heartbeat_report">
                            <a href="/cat/r/topheartbeat?op=view">
                                <i class="menu-icon fa fa-caret-right"></i>小时心跳大盘</a>
                            <b class="arrow"></b></li>
                        <li id="dashbord_hour_transaction_report">
                            <a href="/cat/r/toptransaction?op=view">
                                <i class="menu-icon fa fa-caret-right"></i>小时事务大盘</a>
                            <b class="arrow"></b></li>
                        <b class="arrow"></b>
                    </ul>
                </li>
