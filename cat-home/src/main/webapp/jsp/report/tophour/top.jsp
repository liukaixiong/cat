...
<jsp:useBean id="ctx" type="com.dianping.cat.report.page.tophour.Context" scope="request"/>
<jsp:useBean id="payload" type="com.dianping.cat.report.page.tophour.Payload" scope="request"/>
<jsp:useBean id="model" type="com.dianping.cat.report.page.tophour.Model" scope="request"/>
 ...
 <c:choose>
	...
	<c:otherwise>
		<a:hourly_report title="TopHour Report" navUrlPrefix="domain=${model.domain}&op=view">
		...
		<div class="report">
			<%--<div class="text-center">--%>
		 		<%--<%@ include file="../tophour/timeNav.jsp"%>--%>
			<%--</div>--%>
			<div class="">
				<%@ include file="../tophour/topMetric.jsp"%>
			</div>
			<style>
			.ui-tooltip {
				max-width:36555px;
...
$(document).ready(function() {
	...
	$('#dashbord_hour_report').addClass("active");
